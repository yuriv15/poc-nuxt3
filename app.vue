    ...
    >
        ...
        >
            <Button
                ...
                :label="`Alterar para ${colorMode.preference === 'light' ? 'escuro' : 'claro'}`"
            />
            <h1
                class="text-4xl text-black dark:text-white font-bold text-center"
            >
            ...
            <Panel header="Default Preset">
                <p>
                    First panel component uses the global pass through preset
                    from Lara.
                </p>
            </Panel>
            ...
            >
                <p>
                    Second panel overrides the header section with custom a
                    custom style.
                </p>
            </Panel>
            ...
            >
                <p>
                    ...
                    <b>mergeSections: false</b> and applies a custom style to
                    all elements of the panel instead.
                </p>
            </Panel>
        </section>
    </div>
...
watch(colorMode, newVal => {
    if (typeof document !== 'undefined') {
        document.body.classList.remove(bodyClass.value);
        bodyClass.value = newVal.preference;
...
onMounted(() => {
    if (typeof document !== 'undefined') {
        bodyClass.value = colorMode.preference;
        document.body.classList.add(bodyClass.value);
    }
});
</script>
