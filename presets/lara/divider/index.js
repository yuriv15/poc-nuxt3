    ...
    root: ({ props }) => ({
        class: [
            ...
            { 'items-center': props.layout == 'vertical' },
            {
                ...
                'justify-end':
                    props?.align == 'right' && props.layout == 'horizontal',
                'items-center':
                    props?.align == 'top' && props.layout == 'vertical',
                'items-start':
                    props?.align == 'center' && props.layout == 'vertical',
                'items-end':
                    props?.align == 'bottom' && props.layout == 'vertical',
            },
